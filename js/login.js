...
async function handleGoogleLogin() {
  try {
    ...
    if (error.code === "auth/unauthorized-domain")
      showToast("Erro: Domínio não autorizado no Firebase.", "error");
...
if (googleBtnRegister)
  googleBtnRegister.addEventListener("click", handleGoogleLogin);
...
registerForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    try {
      ...
      console.log("Erro ao setar nome no Auth", e);
    }
